...
namespace ElasticLinq.Request.Criteria
{
    ...
    /// </summary>
    abstract class CompoundCriteria : CriteriaWrapper<CompoundCriteria>, ICriteria
    {
        /// <summary>
        ...
        protected CompoundCriteria(IEnumerable<ICriteria> criteria, string pathName = null, bool isNested = false) : base (pathName, isNested)
        {
