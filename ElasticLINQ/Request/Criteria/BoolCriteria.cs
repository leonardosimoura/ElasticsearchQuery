...
namespace ElasticLinq.Request.Criteria
{
    ...
    /// </summary>
    class BoolCriteria : CriteriaWrapper<BoolCriteria>, ICriteria
    {
        /// <summary>
        ...
        public BoolCriteria(IEnumerable<ICriteria> must, IEnumerable<ICriteria> should, IEnumerable<ICriteria> mustNot, string pathName = null, bool isNested = false) : base(pathName, isNested)
        {
