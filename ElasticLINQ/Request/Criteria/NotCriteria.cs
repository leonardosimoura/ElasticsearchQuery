...
namespace ElasticLinq.Request.Criteria
{
    ...
    /// </summary>
    class NotCriteria : CriteriaWrapper<NotCriteria>, ICriteria, INegatableCriteria
    {
        /// <summary>
        ...
        /// </remarks>
        NotCriteria(ICriteria criteria, string pathName = null, bool isNested = false) : base(pathName, isNested)
        {
            Criteria = criteria;
        }
