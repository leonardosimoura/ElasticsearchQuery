...
namespace ElasticLinq.Request.Criteria
{
    ...
    class OrCriteria : CompoundCriteria
    {
        ...
        public OrCriteria(string pathName = null, bool isNested = false, params ICriteria[] criteria)
            : base(criteria, pathName, isNested)
        {
        }
        ...
        public static ICriteria Combine(params ICriteria[] criteria)
        {
            ...
            return CombineTermsForSameField(criteria) ?? new OrCriteria(pathName: null, isNested: false, criteria);
        }
